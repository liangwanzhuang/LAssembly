            ...
            else
            {
                ...
                switch (state)
                {
                    case TipsState.Default:
                        frmTips.pctStat.Image = CusControl.Properties.Resources.alarm;
                        break;
                    case TipsState.Success:
                        frmTips.pctStat.Image = CusControl.Properties.Resources.success;
                        break;
                    case TipsState.Info:
                        frmTips.pctStat.Image = CusControl.Properties.Resources.alarm;
                        break;
                    case TipsState.Warning:
                        frmTips.pctStat.Image = CusControl.Properties.Resources.warning;
                        break;
                    case TipsState.Error:
                        frmTips.pctStat.Image = CusControl.Properties.Resources.error;
                        break;
                    default:
                        frmTips.pctStat.Image = CusControl.Properties.Resources.alarm;
                        break;
