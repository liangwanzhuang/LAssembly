...
namespace CusControl.Forms
{
    public partial class FrmInputs : FrmWithOKCancel1
    {
        ...
        public FrmInputs(
            ...
            Dictionary<string, CusControl.Controls.KeyBoardType> keyBoards = null,
            ...
            Dictionary<string, string> defaultValues = null)
        {
            ...
            try
            {
                ...
                CusControl.ControlHelper.FreezeControl(this, true);
                ...
                for (int i = inPutLabels.Length - 1; i >= 0; i--)
                {
                    ...
                    CusControl.Controls.UCTextBoxEx txt = new Controls.UCTextBoxEx();
            ...
            {
                CusControl.ControlHelper.FreezeControl(this, false);
            }
        }
        #endregion
        ...
        protected override void DoEnter()
        {
            for (int i = 0; i < Values.Length; i++)
            {
                ...
                if (cs.Length > 0)
                {
                    var txt = cs[0] as CusControl.Controls.UCTextBoxEx;
                    Values[i] = txt.InputText;
                    if (m_mastInputs.ContainsKey(i) && string.IsNullOrWhiteSpace(txt.InputText))
                    {
                        CusControl.Forms.FrmTips.ShowTipsInfo(this, "[" + m_mastInputs[i] + "]必须输入。");                        
