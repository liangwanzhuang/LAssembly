...
namespace CusControl.Controls
{
    public partial class UCProcessEllipse : UserControl
    {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            if (m_showType == CusControl.Controls.ShowType.Ring)
            {
                //中心圆
                ...
                if (m_value > 0 && m_maxValue > 0)
                {
                    ...
                    string strValueText = m_valueType == CusControl.Controls.ValueType.Percent ? fltPercent.ToString("0%") : m_value.ToString();
