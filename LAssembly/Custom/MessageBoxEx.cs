//----------------------------------------------摘要-----------------------------------------------
// 产品名称：嘉和口腔专科电子病历
// 文件名称：MessageBoxEx.cs
// 创建日期：2019-07-29 by zhuangliang
// 功能描述：重写MessageBox弹出框
//-------------------------------------------------------------------------------------------------
using System;
...
namespace MR.LTools.Custom
{
    ...
    {
        public static DialogResult Show(string text, string[] buttonTitles)
        {
    ...
    MessageBoxIcon icon, string[] buttonTitles)
        {
            MessageForm frm = new MessageForm(buttons, buttonTitles);
            frm.Show();
            frm.WatchForActivate = true;
