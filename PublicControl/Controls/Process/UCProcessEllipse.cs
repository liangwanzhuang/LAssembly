...
namespace PublicControl.Controls
{
    public partial class UCProcessEllipse : UserControl
    {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            if (m_showType == PublicControl.Controls.ShowType.Ring)
            {
                //中心圆
                ...
                if (m_value > 0 && m_maxValue > 0)
                {
                    ...
                    string strValueText = m_valueType == PublicControl.Controls.ValueType.Percent ? fltPercent.ToString("0%") : m_value.ToString();
