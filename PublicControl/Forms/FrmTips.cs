            ...
            else
            {
                ...
                switch (state)
                {
                    case TipsState.Default:
                        frmTips.pctStat.Image = PublicControl.Properties.Resources.alarm;
                        break;
                    case TipsState.Success:
                        frmTips.pctStat.Image = PublicControl.Properties.Resources.success;
                        break;
                    case TipsState.Info:
                        frmTips.pctStat.Image = PublicControl.Properties.Resources.alarm;
                        break;
                    case TipsState.Warning:
                        frmTips.pctStat.Image = PublicControl.Properties.Resources.warning;
                        break;
                    case TipsState.Error:
                        frmTips.pctStat.Image = PublicControl.Properties.Resources.error;
                        break;
                    default:
                        frmTips.pctStat.Image = PublicControl.Properties.Resources.alarm;
                        break;
